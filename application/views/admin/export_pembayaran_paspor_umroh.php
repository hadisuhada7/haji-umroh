<html>
	...
	<body>
		...
		<?php 
			...
			header("Content-Disposition: attachment; filename=laporan_pembayaran_paspor_umroh.xls");
			header("Pragma: no-cache");
			header("Expires: 0");
		?>			
		<center><h4> Laporan Data Pembayaran Papsor Umroh <br> KBIH Al-Hidayah Kota Cirebon <br> Bulan <?php echo $blnnama; echo " "; echo date('Y'); ?></h4></center>
		<table width="100%" border="solid" bgcolor="white" align="center">
			...
			<?php
               $no_urut = 0;
               foreach($pembayaran_paspor_umroh as $row)
               {
               	  $no_urut++;
                  ?>
                  <tr>
