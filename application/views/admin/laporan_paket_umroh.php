<html>
	...
	<body>
		...
		<table width="100%" border="solid" bgcolor="white" align="center">
			...
			<?php
               $no_urut = 0;
               foreach($laporan_paket_umroh as $row)
               {
               	  $no_urut++;
                  ?>
                  <tr>
		...
		<script>
			function print_d(){
				window.open("<?php echo base_url();?>index.php/welcome/print_paket_umroh","_blank");
			}
			function export_e(){
				window.open("<?php echo base_url();?>index.php/welcome/export_excel_paket_umroh");
			}
		</script>
		<br>
