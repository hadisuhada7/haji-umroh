...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Paket Haji Plus </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $paket_haji_plus->row();
            echo form_open('welcome/edit_paket_haji_plus/'.$row->id_paket_haji_plus);
         ?>
         <table width='100%'>
             <tr>
               <td width='180px'><b>Id. Paket Haji Plus</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_paket_haji_plus" class="kecil" value="<?php echo $row->id_paket_haji_plus; ?>" readonly />
               </td>
            </tr>
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('nama_program',$row->nama_program,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('durasi',$row->durasi,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('pesawat',$row->pesawat,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('hotel_makkah',$row->hotel_makkah,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('hotel_madinah',$row->hotel_madinah,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('seat',$row->seat,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('sisa_seat',$row->sisa_seat,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('nama_travel',$row->nama_travel,'class=panjang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('no_izin',$row->no_izin,'class=sedang');?>
