...
<div id='main-wrap'>
   <div id='main-center'>
      ...
      <div id='main'>
         ...
         <?php echo form_open('welcome/insert_pengeluaran_operasional');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Pengeluaran</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_pengeluaran" class="kecil" value="<?php echo $kode_pengeluaran_operasional; ?>" readonly />
               </td>
            </tr>
            <tr>
               <td><b>Nama Operasional</b></td>
               <td>:</td>
               <td>
                  <?php echo form_input('nama_operasional',set_value('nama_operasional'),'class=panjang');?>
                  <?php echo form_error('nama_operasional');?>
               </td>
            </tr>
            <tr>
               <td><b>Jumlah</b></td>
