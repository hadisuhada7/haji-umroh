...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Input Paspor Umroh</span>
      </div>
      <div id='main'>

         <?php echo form_open('welcome/insert_paspor_umroh');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Paspor</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_paspor" class="kecil" value="<?php echo $kode_paspor_umroh; ?>" readonly />
               </td>
            </tr>
            <tr>
