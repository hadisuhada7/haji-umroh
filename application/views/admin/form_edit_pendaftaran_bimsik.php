...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Pendaftaran Bimbingan Manasik </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $pendaftaran_bimsik->row();
            echo form_open('welcome/edit_pendaftaran_bimsik/'.$row->id_pendaftaran_bimsik);
         ?>
         <table width='100%'>
            <tr>
               ...
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_pendaftaran_bimsik" class="kecil" value="<?php echo $row->id_pendaftaran_bimsik; ?>" readonly />
               </td>
            </tr>
            <tr> 
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('no_porsi',$row->no_porsi,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('tahun',$row->tahun,'class=sedang');?>
