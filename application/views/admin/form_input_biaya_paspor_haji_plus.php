...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Input Biaya Paspor Haji Plus </span>
      </div>
      <div id='main'>

         <?php echo form_open('welcome/insert_biaya_paspor_haji_plus');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Biaya Paspor</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_biaya_paspor" class="kecil" value="<?php echo $kode_biaya_paspor_haji_plus; ?>" readonly />
               </td>
            </tr>
            <tr>
