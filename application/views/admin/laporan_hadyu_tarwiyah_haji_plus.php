<html>
	...
	<body>
		...
		<table width="100%" border="solid" bgcolor="white" align="center">
			...
			<?php
               $no_urut = 0;
               foreach($laporan_hadyu_tarwiyah_haji_plus as $row)
               {
               	  $no_urut++;
                  ?>
                  <tr>
		...
		<script>
			function print_d(){
				window.open("<?php echo base_url();?>index.php/welcome/print_hadyu_tarwiyah_haji_plus","_blank");
			}
			function export_e(){
				window.open("<?php echo base_url();?>index.php/welcome/export_excel_hadyu_tarwiyah_haji_plus");
			}
		</script>
		<br>
