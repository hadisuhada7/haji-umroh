<html>
	...
	<body>
		...
		<?php 
			...
			header("Content-Disposition: attachment; filename=laporan_umroh.xls");
			...
			<?php
               ...
               foreach($umroh as $row)
               {
                  ...
                  <tr>
                     ...
                     <td><?php echo $row->terakhir_umroh;?></td>
