...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Input Peserta </span>
      </div>
      <div id='main'>

         <?php echo form_open('welcome/insert_bimsik');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Peserta</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_peserta" class="kecil" value="<?php echo $kode_bimsik; ?>" readonly />
               </td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('no_porsi',set_value('no_porsi'),'class=kecil');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('no_spph',set_value('no_spph'),'class=kecil');?>
