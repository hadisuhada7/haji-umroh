...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Paket Umroh </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $paket_umroh->row();
            echo form_open('welcome/edit_paket_umroh/'.$row->id_paket_umroh);
         ?>
         <table width='100%'>
             <tr>
               ...
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_paket_umroh" class="kecil" value="<?php echo $row->id_paket_umroh; ?>" readonly />
               </td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('hotel_turki',$row->hotel_turki,'class=sedang');?>
