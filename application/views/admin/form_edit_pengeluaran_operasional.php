...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Pengeluaran Operasional </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $pengeluaran_operasional->row();
            echo form_open('welcome/edit_pengeluaran_operasional/'.$row->id_pengeluaran);
         ?>
         <table width='100%'>
             <tr>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('nama_operasional',$row->nama_operasional,'class=panjang');?>
