...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Input Pendaftaran Bimbingan Manasik </span>
      </div>
      <div id='main'>

         <?php echo form_open('welcome/insert_pendaftaran_bimsik');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Pendaftaran</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_pendaftaran_bimsik" class="kecil" value="<?php echo $kode_pendaftaran_bimsik; ?>" readonly />
               </td>
            </tr>
            <tr> 
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('no_porsi',set_value('no_porsi'),'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('tahun',set_value('tahun'),'class=sedang');?>
