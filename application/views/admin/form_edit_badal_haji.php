...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Badal Haji </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $badal_haji->row();
            echo form_open('welcome/edit_badal_haji/'.$row->id_badal_haji);
         ?>
         <table width='100%'>
            <tr>
               ...
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_badal_haji" class="kecil" value="<?php echo $row->id_badal_haji; ?>" readonly />
               </td>
            </tr>
            <tr> 
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('dibadalkan_oleh',$row->dibadalkan_oleh,'class=sedang');?>
