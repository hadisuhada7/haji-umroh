...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Pendaftaran Haji </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $pendaftaran_haji->row();
            echo form_open('welcome/edit_pendaftaran_haji/'.$row->id_pendaftaran_haji);
         ?>
         <table width='100%'>
            <tr>
               ...
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_pendaftaran_haji" class="kecil" value="<?php echo $row->id_pendaftaran_haji; ?>" readonly />
               </td>
            </tr>
            <tr> 
            ...
            <tr>
               ...
               <td>:</td>
               <td> <select name="paket_haji">
                        <option value="<?php echo $row->paket_haji ?>"> <?php echo $row->paket_haji; ?> </option>
                        <option value='...'> ... </option>
