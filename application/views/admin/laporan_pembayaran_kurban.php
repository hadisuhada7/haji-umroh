<html>
	...
	<body>
		...
		<table width="100%" border="solid" bgcolor="white" align="center">
			...
			<?php
               $no_urut = 0;
               foreach($laporan_pembayaran_kurban as $row)
               {
               	  $no_urut++;
                  ?>
                  <tr>
		...
		<script>
			function print_d(){
				window.open("<?php echo base_url();?>index.php/welcome/print_pembayaran_kurban","_blank");
			}
			function export_e(){
				window.open("<?php echo base_url();?>index.php/welcome/export_excel_pembayaran_kurban");
			}
		</script>
		<br>
