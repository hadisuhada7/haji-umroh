...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Input Paket Haji Plus </span>
      </div>
      <div id='main'>

         <?php echo form_open('welcome/insert_paket_haji_plus');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Paket Haji Plus</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_paket_haji_plus" class="kecil" value="<?php echo $kode_paket_haji_plus; ?>" readonly />
               </td>
            </tr>
            <tr>
