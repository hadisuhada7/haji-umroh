<html>
	<head>
		<title> Laporan Pembayaran Papsor Haji </title>
	...
	<body>
		...
		<?php 
			...
			header("Content-Disposition: attachment; filename=laporan_pembayaran_paspor_bimsik.xls");
			header("Pragma: no-cache");
			header("Expires: 0");
		?>			
		<center><h4> Laporan Data Pembayaran Papsor Haji <br> KBIH Al-Hidayah Kota Cirebon <br> Bulan <?php echo $blnnama; echo " "; echo date('Y'); ?></h4></center>
		<table width="100%" border="solid" bgcolor="white" align="center">
			...
			<?php
               $no_urut = 0;
               foreach($pembayaran_paspor_bimsik as $row)
               {
               	  $no_urut++;
                  ?>
                  <tr>
