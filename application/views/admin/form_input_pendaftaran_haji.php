...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Input Pendaftaran Haji </span>
      </div>
      <div id='main'>

         <?php echo form_open('welcome/insert_pendaftaran_haji');?>
         <table width='100%'>
            <tr>
               <td width='180px'><b>Id. Pendaftaran</b></td>
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_pendaftaran_haji" class="kecil" value="<?php echo $kode_pendaftaran_haji; ?>" readonly />
               </td>
            </tr>
            <tr> 
