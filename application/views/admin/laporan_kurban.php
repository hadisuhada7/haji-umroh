<html>
	...
	<body>
		...
		?>		
		<center><h4> Laporan Data Kurban <br> KBIH Al-Hidayah Kota Cirebon <br> Bulan <?php echo $blnnama; echo " "; echo date('Y'); ?></h4></center>
		...
		<script>
			function print_d(){
				window.open("<?php echo base_url();?>index.php/welcome/print_kurban","_blank");
			}
			function export_e(){
				window.open("<?php echo base_url();?>index.php/welcome/export_excel_kurban");
			}
		</script>
		<br>
