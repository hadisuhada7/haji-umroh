...
<div id='main-wrap'>
   <div id='main-center'>
      <div id='head-main'>
         <span> Form Edit Umroh </span>
      </div>
      <div id='main'>
    
         <?php
            $row = $umroh->row();
            echo form_open('welcome/edit_umroh/'.$row->id_umroh);
         ?>
         <table width='100%'>
            <tr>
               ...
               <td width='10px'>:</td>
               <td>
                  <input type="text" name="id_umroh" class="kecil" value="<?php echo $row->id_umroh; ?>" readonly />
               </td>
            </tr>
            <tr> 
            ...
            <tr>
               ...
               <td>
                  <?php
                     ...
                     foreach($paket_umroh->result() as $rows)
                     {
                        $array_paket_umroh[$rows->id_paket_umroh] = $rows->nama_program;
                     }
                     echo form_dropdown('paket_umroh',$array_paket_umroh,$row->id_paket_umroh);
                  ?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('nama_ayah',$row->nama_ayah,'class=sedang');?>
            ...
            <tr>
               ...
               <td>:</td>
               <td>
                  <?php echo form_input('nama_ibu',$row->nama_ibu,'class=sedang');?>
            ...
            <tr> 
               ...
               <td>:</td>
               <td><input type="date" name="terakhir_umroh" required value="<?php echo $row->terakhir_umroh; ?>" /></td>
            </tr>
            <tr>
