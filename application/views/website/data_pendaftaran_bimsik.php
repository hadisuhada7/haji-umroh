<html>
	<head>
		<title> Pendaftaran Bimbingan Manasik </title>
	...
	<body>
		...
		<center>
         ...
         <h4> Data Pendaftaran Bimbingan Manasik <br> KBIH Al-Hidayah Kota Cirebon </h4>
      </center>
      <br>
		<table width="70%" align="center">
            <?php
               foreach($pendaftaran_bimsik->result() as $row)
               {
                  ?>
                  <tr>
                     ...
                     <td width='10px'>:</td>
                     <td>
                        <?php echo $row->id_pendaftaran_bimsik;?>
                     </td>
                  </tr>
                  <tr> 
      ...
      <br>
        <table width="70%" align="center">
            <tr>
               <td> Dengan ini, saya bersedia menandatangani formulir pendaftaran bimbingan manasik, serta akan menerima dan tunduk pada ketentuan yang berlaku. </td>
            </tr>
        </table>
		<br><br><br>
      ...
      <script>
         function print_d(){
            window.open("<?php echo base_url();?>index.php/website/print_pendaftaran_bimsik","_blank");
         }
      </script>
      <br><br>
	</body>
